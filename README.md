...
[![GoDoc](https://godoc.org/github.com/irijopa/telebot?status.svg)](https://godoc.org/github.com/irijopa/telebot)
...
```bash
go get -u github.com/irijopa/telebot
```
...
[here](https://godoc.org/github.com/irijopa/telebot#pkg-constants).
...
implementations:
```go
import "github.com/irijopa/telebot/middleware"
```
...
[here](https://pkg.go.dev/github.com/irijopa/telebot#Option).
